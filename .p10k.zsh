# Generated by Powerlevel10k configuration wizard on 2019-10-01 at 22:59 CEST.
...
() {
  ...
  BOLD() {
    typeset -g ${1}_CONTENT_EXPANSION="%B"'${P9K_CONTENT}'
  ...
  customize() {
    ...
    typeset -g POWERLEVEL9K_CUSTOM_OS_ICON_BACKGROUND=009
    typeset -g POWERLEVEL9K_HOST_FOREGROUND=$DEFAULT_DARK
    typeset -g POWERLEVEL9K_HOST_BACKGROUND=001
    typeset -g POWERLEVEL9K_USER_FOREGROUND=$DEFAULT_DARK
    typeset -g POWERLEVEL9K_USER_BACKGROUND=160
    typeset -g POWERLEVEL9K_DIR_FOREGROUND=$DEFAULT_DARK
    typeset -g POWERLEVEL9K_DIR_BACKGROUND=196
    typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=$DEFAULT_DARK
    typeset -g POWERLEVEL9K_DIR_ANCHOR_BACKGROUND=36

    BOLD POWERLEVEL9K_HOST
    BOLD POWERLEVEL9K_USER
    BOLD POWERLEVEL9K_DIR_ANCHOR
  }
  ...
  typeset -ga POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
      # =========================[ Line #1 ]=========================
      custom_os_icon          # Arch icon. os_icon for supported font
      host
      user
